...
public class AbyssDirtBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:abyss_dirt")
	public static final Block block = null;

	public AbyssDirtBlock(GrandcupModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(2f, 10f).setLightLevel(s -> 0));
			setRegistryName("abyss_dirt");
		}
