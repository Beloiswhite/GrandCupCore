...
public class AbyssWoodFenceBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:abyss_wood_fence")
	public static final Block block = null;

	public AbyssWoodFenceBlock(GrandcupModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("abyss_wood_fence");
		}
