...
public class AbyssWoodFenceGateBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:abyss_wood_fence_gate")
	public static final Block block = null;

	public AbyssWoodFenceGateBlock(GrandcupModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("abyss_wood_fence_gate");
		}
