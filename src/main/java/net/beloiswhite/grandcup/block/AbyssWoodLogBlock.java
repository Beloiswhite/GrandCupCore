...
public class AbyssWoodLogBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:abyss_wood_log")
	public static final Block block = null;

	public AbyssWoodLogBlock(GrandcupModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("abyss_wood_log");
		}
