...
public class AbyssWoodWoodBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:abyss_wood_wood")
	public static final Block block = null;

	public AbyssWoodWoodBlock(GrandcupModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3.8f, 3.3422033980522823f).setLightLevel(s -> 0)
					.harvestLevel(2).harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("abyss_wood_wood");
		}
