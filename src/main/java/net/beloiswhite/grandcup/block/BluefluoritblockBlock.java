...
public class BluefluoritblockBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:bluefluoritblock")
	public static final Block block = null;

	public BluefluoritblockBlock(GrandcupModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluefluoritblock");
		}
