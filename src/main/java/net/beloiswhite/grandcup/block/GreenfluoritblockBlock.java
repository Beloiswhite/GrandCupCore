...
public class GreenfluoritblockBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:greenfluoritblock")
	public static final Block block = null;

	public GreenfluoritblockBlock(GrandcupModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("greenfluoritblock");
		}
