...
public class InsomniaButtonBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomnia_button")
	public static final Block block = null;

	public InsomniaButtonBlock(GrandcupModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("insomnia_button");
		}
