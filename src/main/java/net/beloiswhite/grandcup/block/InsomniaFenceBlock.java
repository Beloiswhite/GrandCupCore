...
public class InsomniaFenceBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomnia_fence")
	public static final Block block = null;

	public InsomniaFenceBlock(GrandcupModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("insomnia_fence");
		}
