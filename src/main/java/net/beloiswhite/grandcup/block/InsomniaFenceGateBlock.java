...
public class InsomniaFenceGateBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomnia_fence_gate")
	public static final Block block = null;

	public InsomniaFenceGateBlock(GrandcupModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("insomnia_fence_gate");
		}
