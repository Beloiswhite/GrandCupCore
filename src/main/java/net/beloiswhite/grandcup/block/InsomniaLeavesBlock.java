...
public class InsomniaLeavesBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomnia_leaves")
	public static final Block block = null;

	public InsomniaLeavesBlock(GrandcupModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("insomnia_leaves");
		}
