...
public class InsomniaLogBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomnia_log")
	public static final Block block = null;

	public InsomniaLogBlock(GrandcupModElements instance) {
		super(instance, 17);
	}
