...
public class InsomniaPlanksBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomnia_planks")
	public static final Block block = null;

	public InsomniaPlanksBlock(GrandcupModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("insomnia_planks");
		}
