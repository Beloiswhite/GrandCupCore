...
public class InsomniaSlabBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomnia_slab")
	public static final Block block = null;

	public InsomniaSlabBlock(GrandcupModElements instance) {
		super(instance, 21);
	}
