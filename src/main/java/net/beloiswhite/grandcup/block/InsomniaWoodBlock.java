...
public class InsomniaWoodBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomnia_wood")
	public static final Block block = null;

	public InsomniaWoodBlock(GrandcupModElements instance) {
		super(instance, 16);
	}
