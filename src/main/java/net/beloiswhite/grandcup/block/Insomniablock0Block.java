...
public class Insomniablock0Block extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomniablock_0")
	public static final Block block = null;

	public Insomniablock0Block(GrandcupModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("insomniablock_0");
		}
