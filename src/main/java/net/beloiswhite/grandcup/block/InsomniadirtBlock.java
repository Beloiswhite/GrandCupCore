...
public class InsomniadirtBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomniadirt")
	public static final Block block = null;

	public InsomniadirtBlock(GrandcupModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(2f, 10f).setLightLevel(s -> 0).harvestLevel(2)
					.harvestTool(ToolType.SHOVEL).setRequiresTool());
			setRegistryName("insomniadirt");
		}
