...
public class InsomniagrassBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:insomniagrass")
	public static final Block block = null;

	public InsomniagrassBlock(GrandcupModElements instance) {
		super(instance, 34);
	}
