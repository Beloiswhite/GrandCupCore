...
public class KorundOreBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:korund_ore")
	public static final Block block = null;

	public KorundOreBlock(GrandcupModElements instance) {
		super(instance, 58);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("grandcup:korund_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("korund_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("grandcup:korund_ore"), configuredFeature);
		}
	}
