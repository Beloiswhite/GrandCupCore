...
public class PeacefulButtonBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_button")
	public static final Block block = null;

	public PeacefulButtonBlock(GrandcupModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("peaceful_button");
		}
