...
public class PeacefulFenceBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_fence")
	public static final Block block = null;

	public PeacefulFenceBlock(GrandcupModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("peaceful_fence");
		}
