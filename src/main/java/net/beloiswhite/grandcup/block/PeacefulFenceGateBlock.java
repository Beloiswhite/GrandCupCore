...
public class PeacefulFenceGateBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_fence_gate")
	public static final Block block = null;

	public PeacefulFenceGateBlock(GrandcupModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("peaceful_fence_gate");
		}
