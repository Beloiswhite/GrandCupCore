...
public class PeacefulLogBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_log")
	public static final Block block = null;

	public PeacefulLogBlock(GrandcupModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 2.766323734445183f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("peaceful_log");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PeacefulLogBlock.block));
		}
	}
}
