...
public class PeacefulPlanks1Block extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_planks_1")
	public static final Block block = null;

	public PeacefulPlanks1Block(GrandcupModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("peaceful_planks_1");
		}
