...
public class PeacefulPlanks2Block extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_planks_2")
	public static final Block block = null;

	public PeacefulPlanks2Block(GrandcupModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("peaceful_planks_2");
		}
