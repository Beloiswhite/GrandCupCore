...
public class PeacefulPlanks3Block extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_planks_3")
	public static final Block block = null;

	public PeacefulPlanks3Block(GrandcupModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("peaceful_planks_3");
		}
