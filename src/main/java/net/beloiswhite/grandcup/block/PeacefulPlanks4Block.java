...
public class PeacefulPlanks4Block extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_planks_4")
	public static final Block block = null;

	public PeacefulPlanks4Block(GrandcupModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("peaceful_planks_4");
		}
