...
public class PeacefulPlanksBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_planks")
	public static final Block block = null;

	public PeacefulPlanksBlock(GrandcupModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("peaceful_planks");
		}
