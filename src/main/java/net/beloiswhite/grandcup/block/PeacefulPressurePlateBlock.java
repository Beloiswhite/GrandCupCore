...
public class PeacefulPressurePlateBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_pressure_plate")
	public static final Block block = null;

	public PeacefulPressurePlateBlock(GrandcupModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("peaceful_pressure_plate");
		}
