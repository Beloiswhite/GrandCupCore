...
public class PeacefulSlabBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_slab")
	public static final Block block = null;

	public PeacefulSlabBlock(GrandcupModElements instance) {
		super(instance, 76);
	}
