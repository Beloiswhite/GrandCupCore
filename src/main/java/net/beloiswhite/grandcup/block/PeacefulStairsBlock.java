...
public class PeacefulStairsBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_stairs")
	public static final Block block = null;

	public PeacefulStairsBlock(GrandcupModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("peaceful_stairs");
		}
