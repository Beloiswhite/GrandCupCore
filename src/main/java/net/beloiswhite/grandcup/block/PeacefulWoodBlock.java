...
public class PeacefulWoodBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:peaceful_wood")
	public static final Block block = null;

	public PeacefulWoodBlock(GrandcupModElements instance) {
		super(instance, 71);
	}
