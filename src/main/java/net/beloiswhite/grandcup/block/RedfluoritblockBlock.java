...
public class RedfluoritblockBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:redfluoritblock")
	public static final Block block = null;

	public RedfluoritblockBlock(GrandcupModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redfluoritblock");
		}
