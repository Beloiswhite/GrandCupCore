...
public class WhitefluoritblockBlock extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:whitefluoritblock")
	public static final Block block = null;

	public WhitefluoritblockBlock(GrandcupModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 100f).setLightLevel(s -> 3).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().setNeedsPostProcessing((bs, br, bp) -> true)
					.setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("whitefluoritblock");
		}
