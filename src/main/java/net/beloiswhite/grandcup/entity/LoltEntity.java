...
import net.beloiswhite.grandcup.procedures.LoltPriObnovlieniiTaktaSushchnostiProcedure;
...
public class LoltEntity extends GrandcupModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(2f, 2.7f)).build("lolt").setRegistryName("lolt");

	public LoltEntity(GrandcupModElements instance) {
		super(instance, 100);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LoltGeckolibEntity());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14811136, -13434880, new Item.Properties().group(TabItemGroup.tab))
				.setRegistryName("lolt_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.FOLLOW_RANGE, 35);
	...
	public static class CustomEntity extends MonsterEntity implements IAnimatable {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("grandcup:nether_lolt_living"));
		}
		...
		public void baseTick() {
			...
			LoltPriObnovlieniiTaktaSushchnostiProcedure.executeProcedure(Collections.emptyMap());
		}
