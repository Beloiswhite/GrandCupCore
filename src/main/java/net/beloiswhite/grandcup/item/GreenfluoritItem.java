...
public class GreenfluoritItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:greenfluorit")
	public static final Item block = null;

	public GreenfluoritItem(GrandcupModElements instance) {
		super(instance, 11);
	}
