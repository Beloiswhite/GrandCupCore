...
public class KorundAxeItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:korund_axe")
	public static final Item block = null;

	public KorundAxeItem(GrandcupModElements instance) {
		super(instance, 62);
	}
