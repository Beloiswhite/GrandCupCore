...
public class KorundIngotItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:korund_ingot")
	public static final Item block = null;

	public KorundIngotItem(GrandcupModElements instance) {
		super(instance, 60);
	}
