...
public class KorundShovelItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:korund_shovel")
	public static final Item block = null;

	public KorundShovelItem(GrandcupModElements instance) {
		super(instance, 64);
	}
