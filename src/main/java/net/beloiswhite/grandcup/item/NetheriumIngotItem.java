...
public class NetheriumIngotItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:netherium_ingot")
	public static final Item block = null;

	public NetheriumIngotItem(GrandcupModElements instance) {
		super(instance, 45);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("netherium_ingot");
		}
