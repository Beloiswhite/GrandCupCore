...
public class OoniumItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:oonium")
	public static final Item block = null;

	public OoniumItem(GrandcupModElements instance) {
		super(instance, 48);
	}
