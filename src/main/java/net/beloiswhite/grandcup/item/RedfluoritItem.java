...
public class RedfluoritItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:redfluorit")
	public static final Item block = null;

	public RedfluoritItem(GrandcupModElements instance) {
		super(instance, 10);
	}
