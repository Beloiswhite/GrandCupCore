...
public class ReinforcedStickItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:reinforced_stick")
	public static final Item block = null;

	public ReinforcedStickItem(GrandcupModElements instance) {
		super(instance, 57);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("reinforced_stick");
		}
