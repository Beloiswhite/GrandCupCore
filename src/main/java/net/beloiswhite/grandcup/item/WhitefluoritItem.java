...
public class WhitefluoritItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:whitefluorit")
	public static final Item block = null;

	public WhitefluoritItem(GrandcupModElements instance) {
		super(instance, 14);
	}
