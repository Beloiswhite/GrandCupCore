...
public class YellowfluoritItem extends GrandcupModElements.ModElement {
	@ObjectHolder("grandcup:yellowfluorit")
	public static final Item block = null;

	public YellowfluoritItem(GrandcupModElements instance) {
		super(instance, 13);
	}
