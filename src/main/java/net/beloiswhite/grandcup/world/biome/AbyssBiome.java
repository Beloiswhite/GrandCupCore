...
import net.beloiswhite.grandcup.particle.AbyssconfusedparticleParticle;
import net.beloiswhite.grandcup.block.AbyssGrassBlockBlock;
import net.beloiswhite.grandcup.block.AbyssDirtBlock;
...
public class AbyssBiome extends GrandcupModElements.ModElement {
	public static Biome biome;

	public AbyssBiome(GrandcupModElements instance) {
		super(instance, 125);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13434880).setWaterColor(-16777216).setWaterFogColor(-16777216)
						.withSkyColor(-13434880).withFoliageColor(-14483456).withGrassColor(-13434880)
						.setParticle(new ParticleEffectAmbience(AbyssconfusedparticleParticle.particle, 0.01f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(AbyssGrassBlockBlock.block.getDefaultState(),
								AbyssDirtBlock.block.getDefaultState(), AbyssDirtBlock.block.getDefaultState())));
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0f).scale(0.2f).temperature(1f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("grandcup:abyss"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("abyss_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("abyss_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
