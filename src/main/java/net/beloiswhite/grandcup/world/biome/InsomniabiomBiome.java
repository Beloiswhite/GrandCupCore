...
package net.beloiswhite.grandcup.world.biome;
...
import net.beloiswhite.grandcup.particle.InsomniacircleParticle;
import net.beloiswhite.grandcup.block.InsomniagrassBlock;
import net.beloiswhite.grandcup.block.InsomniadirtBlock;
import net.beloiswhite.grandcup.block.InsomniaLogBlock;
import net.beloiswhite.grandcup.block.InsomniaLeavesBlock;
...
public class InsomniabiomBiome extends GrandcupModElements.ModElement {
	public static Biome biome;

	public InsomniabiomBiome(GrandcupModElements instance) {
		super(instance, 124);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777216).setWaterColor(-16777216).setWaterFogColor(-16777216)
						.withSkyColor(-16777216).withFoliageColor(-13421773).withGrassColor(-13421773)
						.setParticle(new ParticleEffectAmbience(InsomniacircleParticle.particle, 0.001f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(InsomniagrassBlock.block.getDefaultState(),
								InsomniadirtBlock.block.getDefaultState(), InsomniadirtBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(InsomniaLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(InsomniaLeavesBlock.block.getDefaultState()),
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.PLAINS).depth(0f).scale(0.2f).temperature(0.5f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("grandcup:insomniabiom"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("insomniabiom_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("insomniabiom_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("insomniabiom_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
