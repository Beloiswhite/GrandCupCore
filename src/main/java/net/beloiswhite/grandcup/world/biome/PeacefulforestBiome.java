...
import net.beloiswhite.grandcup.particle.PeacefulforestparticleParticle;
import net.beloiswhite.grandcup.block.PeacefulLogBlock;
import net.beloiswhite.grandcup.block.PeacefulLeavesBlock;
...
public class PeacefulforestBiome extends GrandcupModElements.ModElement {
	public static Biome biome;

	public PeacefulforestBiome(GrandcupModElements instance) {
		super(instance, 104);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-16725559).setWaterFogColor(-16725816)
						.withSkyColor(7972607).withFoliageColor(-15887611).withGrassColor(-16286720)
						.setParticle(new ParticleEffectAmbience(PeacefulforestparticleParticle.particle, 0.008f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(PeacefulLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(PeacefulLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("grandcup:peacefulforest"));
			}
		}
	}
	...
	public void init(FMLCommonSetupEvent event) {
		BiomeDictionary.addTypes(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), BiomeDictionary.Type.FOREST,
				BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.JUNGLE, BiomeDictionary.Type.OVERWORLD);
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("peacefulforest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("peacefulforest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("peacefulforest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
