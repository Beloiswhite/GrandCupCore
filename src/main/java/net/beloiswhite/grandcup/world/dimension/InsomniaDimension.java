...
import net.beloiswhite.grandcup.block.InsomniastoneBlock;
...
public class InsomniaDimension extends GrandcupModElements.ModElement {
	public InsomniaDimension(GrandcupModElements instance) {
		super(instance, 101);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(InsomniastoneBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("grandcup:insomniabiom")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("grandcup:insomnia"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
